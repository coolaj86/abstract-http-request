...
(function () {
  ...
  ['HEAD', 'GET', 'DELETE', 'OPTIONS'].forEach(function (verb) {
    ahr[verb.toLowerCase()] = function (href, query, options, callback) {
      if (callback) {
        return ahr[verb.toLowerCase()](href, query, options).when(callback);
      }
      options = options || {};
  ...
  ['POST', 'PUT'].forEach(function (verb) {
    ahr[verb.toLowerCase()] = function (href, query, body, options, callback) {
      if (callback) {
        return ahr[verb.toLowerCase()](href, query, body, options).when(callback);
      }
      options = options || {};
