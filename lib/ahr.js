...
(function () {
  ...
  var NativeHttpClient = require('./native-http-client') // load native-http-client-browser when on the browser
  ...
  ['HEAD', 'GET', 'DELETE', 'OPTIONS'].forEach(function (verb) {
    ahr[verb.toLowerCase()] = function (href, params, options, callback) {
      if (callback) {
        return ahr[verb.toLowerCase()](href, params, options).when(callback);
      }
      options = options || {};
      ...
      options.href = href || "";
      // TODO global params
      options.params = preset(params || {}, options.params || {});
  ...
  ['POST', 'PUT'].forEach(function (verb) {
    ahr[verb.toLowerCase()] = function (href, params, body, options, callback) {
      if (callback) {
        return ahr[verb.toLowerCase()](href, params, body, options).when(callback);
      }
      options = options || {};
  ...
  // JSONP
  ahr.jsonp = function (href, jsonp, params, options, callback) {
    if (callback) {
      return ahr.jsonp(href, jsonp, params, options).when(callback);
    }
    options = options || {};
